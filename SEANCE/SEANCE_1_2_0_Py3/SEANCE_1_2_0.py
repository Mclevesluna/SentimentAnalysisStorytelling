...
def main(indir, outfile,var_list):		
		...
		affect_list = open(resource_path('data_files/affective_list.txt'), 'r').read()
		...
		anew_list = open(resource_path('data_files/affective_norms.txt'), 'r').readlines()
		sentic_list = open(resource_path('data_files/senticnet_data.txt'), 'r').readlines()
		lu_hui_positive = open(resource_path('data_files/positive_words.txt'), 'r').read().split("\n")
		lu_hui_negative = open(resource_path('data_files/negative_words.txt'), 'r').read().split("\n")
...
####Beginning of file iteration#######
		...
		for filename in filenames:
			...
			if var_list[1].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_galc(noun_text_neg_3,"_nouns_neg_3")
			if var_list[2].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_nrc(noun_text_neg_3,"_nouns_neg_3")
			if var_list[3].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_anew(noun_text_neg_3,"_nouns_neg_3")
			if var_list[4].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_sentic(noun_text_neg_3,"_nouns_neg_3")
			#if var_list[5].get() == 1 and var_list[9].get() == 1and var_list[14].get() == 1: run_vader(noun_text_neg_3,"_nouns_neg_3")
			if var_list[6].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_lu_hui(noun_text_neg_3,"_nouns_neg_3")
			if var_list[7].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_gi(noun_text_neg_3,"_nouns_neg_3")
			if var_list[8].get() == 1 and var_list[9].get() == 1 and var_list[14].get() == 1: run_lasswell(noun_text_neg_3,"_nouns_neg_3")
			
			#### Verbs Only Negation Checked ####
			if var_list[1].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_galc(verb_text_neg_3,"_verbs_neg_3")
			if var_list[2].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_nrc(verb_text_neg_3,"_verbs_neg_3")
			if var_list[3].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_anew(verb_text_neg_3,"_verbs_neg_3")
			if var_list[4].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_sentic(verb_text_neg_3,"_verbs_neg_3")
			#if var_list[5].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_vader(verb_text_neg_3,"_verbs_neg_3")
			if var_list[6].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_lu_hui(verb_text_neg_3,"_verbs_neg_3")
			if var_list[7].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_gi(verb_text_neg_3,"_verbs_neg_3")
			if var_list[8].get() == 1 and var_list[10].get() == 1 and var_list[14].get() == 1: run_lasswell(verb_text_neg_3,"_verbs_neg_3")	
						
			#### Adjectives Only Negation Checked ####
			if var_list[1].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_galc(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[2].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_nrc(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[3].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_anew(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[4].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_sentic(adjective_text_neg_3,"_adjectives_neg_3")
			#if var_list[5].get() == 1 and var_list[11].get() == 1and var_list[14].get() == 1: run_vader(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[6].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_lu_hui(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[7].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_gi(adjective_text_neg_3,"_adjectives_neg_3")
			if var_list[8].get() == 1 and var_list[11].get() == 1 and var_list[14].get() == 1: run_lasswell(adjective_text_neg_3,"_adjectives_neg_3")	
						
			#### Adverbs Only Negation Checked ####
			if var_list[1].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_galc(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[2].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_nrc(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[3].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_anew(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[4].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_sentic(adverb_text_neg_3,"_adverbs_neg_3")
			#if var_list[5].get() == 1 and var_list[12].get() == 1and var_list[14].get() == 1: run_vader(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[6].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_lu_hui(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[7].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_gi(adverb_text_neg_3,"_adverbs_neg_3")
			if var_list[8].get() == 1 and var_list[12].get() == 1 and var_list[14].get() == 1: run_lasswell(adverb_text_neg_3,"_adverbs_neg_3")
